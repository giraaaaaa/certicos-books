...
// 찜 하트(Figma like/line·like/fill에서 추출).
// filled=true → 채운 하트, false → 외곽선 하트. 색은 currentColor라 부모가 color로 지정한다
// (찜=palette.red, 비찜=palette.gray).
export function HeartIcon({ filled = false, size = 24, className }: HeartIconProps) {
  return (
